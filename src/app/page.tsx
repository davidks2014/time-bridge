    ...
    <div style={{ background: "#FAF7F2", minHeight: "100vh", fontFamily: "Lato, sans-serif", color: "#2C1810" }}>
      ...
      <nav className="tb-landing-nav">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <button onClick={() => router.push("/login")} style={{ background: "none", border: "none", fontSize: 13, color: "#9A8878", fontWeight: 700, cursor: "pointer", fontFamily: "Lato, sans-serif" }}>
            Sign in
          </button>
          <button onClick={() => router.push("/register")} className="tb-landing-nav-cta">
            GET STARTED FREE
          </button>
        </div>
      </nav>
      ...
      <section className="tb-landing-hero">
        ...
        <p style={{ fontSize: 16, color: "#9A8878", lineHeight: 1.8, maxWidth: 480, margin: "0 auto 40px", fontWeight: 300 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
          <button onClick={() => router.push("/register")} style={{ background: "#2C1810", color: "#FAF7F2", border: "none", borderRadius: 12, padding: "16px 32px", fontSize: 14, fontWeight: 700, letterSpacing: "0.08em", cursor: "pointer", fontFamily: "Lato, sans-serif" }}>
            Begin your legacy →
          </button>
          <button onClick={() => document.getElementById("how-it-works")?.scrollIntoView({ behavior: "smooth" })} style={{ background: "transparent", color: "#B8965A", border: "1.5px solid rgba(184,150,90,0.4)", borderRadius: 12, padding: "15px 24px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "Lato, sans-serif" }}>
            See how it works
          </button>
        </div>
      ...
      <div className="tb-landing-trust">
        {["PDPA COMPLIANT", "STORED IN SINGAPORE", "END-TO-END SECURE", "FREE TO START"].map((item) => (
          <div key={item} style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: "rgba(250,247,242,0.7)" }}>{item}</span>
          </div>
        ))}
      </div>
      ...
      <section style={{ padding: "clamp(48px, 8vw, 72px) clamp(16px, 5vw, 40px)" }}>
        ...
        <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 400, color: "#2C1810", textAlign: "center", marginBottom: 40, lineHeight: 1.25 }}>
          Built for people who love deeply<br />and plan ahead.
        </h2>
        <div className="tb-landing-seg-grid">
          <div style={{ background: "#fff", border: "1px solid rgba(184,150,90,0.18)", borderTop: "3px solid #B8965A", borderRadius: 20, padding: "clamp(24px, 4vw, 36px) clamp(20px, 4vw, 32px)" }}>
            ...
            <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(20px, 3vw, 26px)", fontWeight: 600, color: "#2C1810", marginBottom: 12, lineHeight: 1.2 }}>The Planner</div>
          ...
          <div style={{ background: "#fff", border: "1px solid rgba(124,154,126,0.2)", borderTop: "3px solid #7C9A7E", borderRadius: 20, padding: "clamp(24px, 4vw, 36px) clamp(20px, 4vw, 32px)" }}>
            ...
            <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(20px, 3vw, 26px)", fontWeight: 600, color: "#2C1810", marginBottom: 12, lineHeight: 1.2 }}>The Loving Parent</div>
            <div style={{ fontSize: 14, color: "#9A8878", lineHeight: 1.85, marginBottom: 20 }}>
      ...
      <section id="how-it-works" style={{ background: "#2C1810", padding: "clamp(48px, 8vw, 72px) clamp(16px, 5vw, 40px)", textAlign: "center" }}>
        ...
        <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 400, color: "#FAF7F2", marginBottom: 48, lineHeight: 1.25 }}>
        ...
        <div className="tb-landing-hiw-steps">
          {[
            ...
            <div key={step.num} style={{ display: "flex", alignItems: "flex-start", flex: 1, minWidth: 0 }}>
              <div className="tb-landing-hiw-step">
                <div style={{ width: 56, height: 56, borderRadius: "50%", background: "rgba(184,150,90,0.15)", border: "1px solid rgba(184,150,90,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Cormorant Garamond, serif", fontSize: 22, color: "#B8965A", flexShrink: 0 }}>
                  {step.num}
                </div>
                <div>
                  <div style={{ fontSize: 12, fontWeight: 700, color: "#FAF7F2", letterSpacing: "0.06em", marginBottom: 4 }}>{step.title}</div>
                  <div className="tb-landing-hiw-step-sub">{step.sub}</div>
                </div>
              </div>
              {i < 2 && <div style={{ color: "rgba(184,150,90,0.35)", fontSize: 20, marginTop: 16, padding: "0 4px", flexShrink: 0 }}>→</div>}
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: "clamp(48px, 8vw, 72px) clamp(16px, 5vw, 40px)" }}>
        ...
        <div className="tb-landing-pill-grid">
          {[
            { title: "Protect my family", body: "Document your insurance, CPF, and assets. Leave instructions and final words — delivered to your family after you pass.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#B8965A" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
            { title: "A letter to my child", body: "Write now. Deliver on their 18th birthday, graduation day, or wedding. Your words, at exactly the right moment.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#B8965A" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg> },
            { title: "Schedule a memory", body: "Write a message, attach photos or videos, and choose when someone special receives it — now or years from today.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#B8965A" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg> },
          ].map((pill) => (
            <div key={pill.title} style={{ background: "#fff", border: "1px solid rgba(184,150,90,0.15)", borderRadius: 18, padding: "28px 20px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(18px, 3vw, 22px)", fontWeight: 600, color: "#2C1810", marginBottom: 10 }}>{pill.title}</div>
      ...
      <section style={{ background: "#F5F0E8", padding: "clamp(48px, 8vw, 72px) clamp(16px, 5vw, 40px)" }}>
        ...
        <div className="tb-landing-price-grid">
          {[
            ...
            <div key={p.plan} style={{ background: p.featured ? "#2C1810" : "#fff", border: `1px solid ${p.featured ? "#2C1810" : "rgba(184,150,90,0.18)"}`, borderRadius: 18, padding: "24px 20px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: 11, fontWeight: 900, letterSpacing: "0.16em", color: p.featured ? "rgba(184,150,90,0.7)" : "#B8965A", marginBottom: 12 }}>{p.plan}</div>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#B8965A", marginBottom: 12 }}>{p.storage}</div>
      ...
      {/* ── FINAL CTA ── */}
      <section style={{ padding: "clamp(48px, 8vw, 80px) clamp(16px, 5vw, 40px)", textAlign: "center" }}>
        <h2 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "clamp(28px, 5vw, 52px)", fontWeight: 300, color: "#2C1810", lineHeight: 1.2, marginBottom: 16 }}>
          Your love is too important<br />to leave to <em style={{ fontStyle: "italic", color: "#B8965A" }}>chance.</em>
        </h2>
        <p style={{ fontSize: 15, color: "#9A8878", marginBottom: 32 }}>Start for free today. Write your first memory in minutes.</p>
        <button onClick={() => router.push("/register")} style={{ background: "#2C1810", color: "#FAF7F2", border: "none", borderRadius: 12, padding: "16px 40px", fontSize: 15, fontWeight: 700, letterSpacing: "0.08em", cursor: "pointer", fontFamily: "Lato, sans-serif" }}>
          Begin your legacy →
        </button>
